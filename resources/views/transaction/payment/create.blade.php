                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                    value="{{ $transaction->check_in }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                    value="{{ $transaction->check_out }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                    value="{{ differce_date($transaction->check_in,$transaction->check_out) }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                    value="{{ sum_payment($transaction->payments) }}" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="POST"
                                    ...
                                    @csrf
                                    <input type="hidden" name="transation_id" value="{{ $transaction->id }}"/>
                                    <div class="row mb-3">
