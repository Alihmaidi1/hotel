        ...
        <div class="col-lg-6 mb-2">
            <div class="d-grid gap-2 d-md-block">
                ...
                <span data-bs-toggle="tooltip" data-bs-placement="right" title="Payment History">
                    <a href="" class="btn btn-sm shadow-sm myBtn border rounded">
                            ...
                            <tbody>
                                @forelse ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route("payment.create",$transaction->id) }}" class="btn btn-light btn-sm rounded shadow-sm border p-1 m-0 "
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <a class="btn btn-sm btn-primary m-1"
                            href="{{ route("customer.create") }}">No, create
                            new account!</a>
                        <a class="btn btn-sm btn-success m-1"
                            href="{{ route("transaction.create") }}">Yes, use
                            their account!</a>
                    </div>
                </div>
