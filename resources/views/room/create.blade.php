    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border">
            ...
            <div class="card-body p-3">
                <form class="row g-3" method="POST" enctype="multipart/form-data" action="{{route('room.store')}}">
                    @csrf
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control @error('img') is-invalid @enderror" id="img"
                            name="img" value="{{old('img')}}" placeholder="ex: 500000">
                        @error('img')
                        <div class="text-danger mt-1">
                            {{ $message  }}
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea  class="form-control @error('view') is-invalid @enderror" id="view"
                            name="view"  placeholder="ex: 500000">{{old('img')}}</textarea>
                        @error('img')
                        <div class="text-danger mt-1">
                            {{ $message  }}
                        </div>
