                    ...
                    <div class="card shadow-sm border">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table style="vertical-align: middle" class="table text-center table-sm table-hover">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                    ...
                                    <tbody>
                                        @forelse ($rooms as $room)
                                            <tr>
                                                ...
                                                <td><img style="width:70px;height:70px" src="{{ asset("upload/room/".$room->images[0]->url) }}"/></td>
                                                <td>{{ $room->number }}</td>
