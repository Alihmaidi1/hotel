            ...
            <div class="row mt-2 mb-2">
                <div class="col-lg-6 mb-2">
                    <div class="d-grid gap-2 d-md-block">
                        <a href="{{ route('service.create') }}" class="btn btn-sm shadow-sm myBtn border rounded">
                ...
                <div class="col-lg-6 mb-2">
                    <form class="d-flex" method="GET" action="{{ route('status.index') }}">
